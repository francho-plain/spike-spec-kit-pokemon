...
describe('PokeApiService', () => {
    let pokeApiService;
    beforeEach(() => {
        pokeApiService = new pokeApi_1.PokeApiService();
    });
    describe('getPokemon', () => {
        ...
        it('should throw error for invalid Pokemon name', async () => {
            await expect(pokeApiService.getPokemon('invalidpokemon123')).rejects.toThrow("Pokemon 'invalidpokemon123' not found");
        });
        ...
        it('should handle rate limit errors', async () => {
            ...
            await expect(pokeApiService.getPokemon('pikachu')).rejects.toThrow('PokeAPI rate limit exceeded');
            // Restore original
            axios.get = originalGet;
        });
    });
});
//# sourceMappingURL=test-pokeApi.spec.js.map